...
class Alien(Actor):
    ...
    TYPES = {
        '1': (load_animation('/home/lemesh/university/python/games/aliens/img/alien1.png'), 40),
        '2': (load_animation('/home/lemesh/university/python/games/aliens/img/alien2.png'), 20),
        '3': (load_animation('/home/lemesh/university/python/games/aliens/img/alien3.png'), 10)
    }
